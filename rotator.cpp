...
bool Rotator::checkIpt(int ix, int iy, QVector<Item *> &ipt){
...
void Rotator::input(QVector<Item *> &ipt, int, int){
    if(item != nullptr){
        delete item;
    }
    item = ipt[0];
